...
def water_balance_checker_no_print(df, dict_param, iters):
    ...
    # TODO fix d:\repo\urbanwb\urbanwb\uwbm_functions.py:1290: RuntimeWarning: invalid value encountered in double_scalars
    try:
...
def read_parameter_measure_csv(measure_id, parameter_base, apply_measure=True):
    ...
    if cf["cp_meas_inflow_area"] > 0 and cf["op_meas_inflow_area"] > 0:
        tot_meas_area = (
            parameter_base["tot_cp_area"] + parameter_base["tot_op_area"]
        ) / cf["Ain_def"]
