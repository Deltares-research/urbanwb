class WaterBalanceChecker:  # think about make separate waterbalance checker for basics and measure.
    ...
    def __init__(self, tot_area, pr_no_meas_area, cp_no_meas_area, op_no_meas_area, up_no_meas_area, ow_no_meas_area,
        ...
        self.op_meas_inflow_area = meas_inflow_area  # temporary method - needs modification
        self.inflowareaIsoparea = inflowareaIsoparea  # temporary method - needs modification
    ...
    def sol(self, P_atm, e_atm_pr, e_atm_cp, e_atm_op, e_atm_up, e_atm_ow, t_atm_uz, e_atm_meas, tt_atm_meas, tb_atm_meas,
        ...
        # for now we could already make it half generic, by that I mean measure inflow area from paved area is already possible but not for up_measure_inflow_area, ow_measure_inflow_area.
