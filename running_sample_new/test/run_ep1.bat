...
python -m urbanwb.main_with_measure save_to_csv ep_ts.csv ep_neighbourhood.ini ep_measure.ini ep1_results.csv
...
python -m urbanwb.main_with_measure save_to_csv ep_ts.csv ep_neighbourhood.ini ep_measure.ini ep1_results_selected.csv owl r_pr_swds theta_uz --save_all=False 
