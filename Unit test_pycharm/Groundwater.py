...
p_uz_gw = pd.read_csv(path + 'inputdata/p_uz_gw.csv')['p_uz_gw_0']
p_op_gw = pd.read_csv(path + 'inputdata/p_op_gw.csv')['p_op_gw_0']
# b. results of open water level.
owl = pd.read_csv(path + 'inputdata/owl.csv')['owl_0']
...
def validate(a, b, c, d, e, f, g, h, i, A1, A2):
    ...
    Gwl_up = [0]
    Gwl_low = [0]
    Sc_gw = [soil_selector(f, g, h)['stor_coef'].values]
    H_gw = [0]
    S_gw_out = [0]
    D_gw_ow = [0]
    init_gwl_t0 = h
...
P_uz_gw = pd.read_csv(path + 'inputdata/p_uz_gw.csv')
P_op_gw = pd.read_csv(path + 'inputdata/p_op_gw.csv')
Owl = pd.read_csv(path + 'inputdata/owl.csv')
