...
# Load csv file
path = "C:/Users/ZWX/PycharmProjects/UWM/Unit_test/PavedRoof/"
...
validate(1.6, 1.0, 0.0, 1, 0, 1560, 0)

# 2.2 Set 2: intstorcap_pr = 0
validate(0, 1, 0, 2, 1560, 0, 0)

# 2.3 Set 3: intstorcap_pr = 1600
validate(1600, 1, 0, 3, 1560, 0, 0)

# 2.4 Set 4: stormfrac = 0.0
validate(1.6, 0, 0, 4, 1560, 0, 0)

# 2.5 Set 5: stormfrac = 0.37
validate(1.6, 0.37, 0, 5, 1560, 0, 0)

# 2.6 Set 6: discfrac = 1.0
validate(1.6, 1, 1, 6, 1560, 0, 0)

# 2.7 Set 7: discfrac = 0.37
validate(1.6, 1, 0.37, 7, 1560, 0, 0)
