...
# Load csv file
path = "C:/Users/ZWX/PycharmProjects/UWM/Unit_test/OpenWater/"
Inputdata = InputData = pd.read_csv(path + 'input_csv.csv')
...
# from ..... modules
r_up_ow = pd.read_csv(path + 'inputdata/r_up_ow.csv')['r_up_ow_0']
d_gw_ow = pd.read_csv(path + 'inputdata/d_gw_ow.csv')['d_gw_ow_0']
q_swds_ow = pd.read_csv(path + 'inputdata/q_swds_ow.csv')['q_swds_ow_0']
q_mss_ow = pd.read_csv(path + 'inputdata/q_mss_ow.csv')['q_mss_ow_0']
so_swds_ow = pd.read_csv(path + 'inputdata/so_swds_ow.csv')['so_swds_ow_0']
so_mss_ow = pd.read_csv(path + 'inputdata/so_mss_ow.csv')['so_mss_ow_0']
