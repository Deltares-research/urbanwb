...
if __name__ == '__main__':
    ...
    # 2. EXTENDED TESTS (integration tests)
    ...
    i = 1
    print(i)
    validate(1.6, 1.0, 0.0, i, 0, 803.39, 0)

    # 2.2 Set 2: intstorcap_cp = 0
    i = 2
    print(i)
    validate(0, 1, 0, i, 803.39, 0, 0)

    # 2.3 Set 3: intstorcap_cp = 1600
    i = 3
    print(i)
    validate(1600, 1, 0, i, 803.39, 0, 0)

    # 2.4 Set 4: stormfrac = 0.0
    i = 4
    print(i)
    validate(1.6, 0, 0, i, 803.39, 0, 0)

    # 2.5 Set 5: stormfrac = 0.37
    i = 5
    print(i)
    validate(1.6, 0.37, 0, i, 803.39, 0, 0)

    # 2.6 Set 6: discfrac = 1.0
    i = 6
    print(i)
    validate(1.6, 1, 1, i, 803.39, 0, 0)

    # 2.7 Set 7: discfrac = 0.37
    i = 7
    print(i)
    validate(1.6, 1, 0.37, i, 803.39, 0, 0)
