...
if __name__ == '__main__':
    ...
    i = 1
    print(i)
    validate(0, 1, 0, 1, i, 481.61, 0, 0)

    # 2.2 Set 2: intstorcap_op = 1600
    i = 2
    print(i)
    validate(1600, 1, 0, 1, i, 481.61, 0, 0)

    # 2.3 Set 3: stormfrac = 0.0
    i = 3
    print(i)
    validate(1.6, 0, 0, 1, i, 481.61, 0, 0)

    # 2.4 Set 4: stormfrac = 0.37
    i = 4
    print(i)
    validate(1.6, 0.37, 0, 1, i, 481.61, 0, 0)
    ...
    i = 6
    print(i)
    validate(1.6, 1, 0.37, 1, i, 481.61, 0, 0)

    # 2.7 Set 7: infilcap_op = 0
    i = 7
    print(i)
    validate(1.6, 1, 0, 0, i, 481.61, 0, 0)

    # 2.8 Set 8: infilcap_op = 100
    i = 8
    print(i)
    validate(1.6, 1, 0, 100, i, 481.61, 0, 0)

    # 2.9 Set 9: infilcap_op = 0
    i = 9
    print(i)
    validate(1.6, 1, 0, 1, i, 0, 481.61, 481.61)
