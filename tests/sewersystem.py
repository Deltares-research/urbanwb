...
# Load csv file
path = "C:/Users/ZWX/PycharmProjects/UWM/Unit_test/SewerSystem/"
...
r_pr_swds = pd.read_csv(path + 'inputdata/r_swds.csv')['r_pr_swds_0']
r_cp_swds = pd.read_csv(path + 'inputdata/r_swds.csv')['r_cp_swds_0']
r_op_swds = pd.read_csv(path + 'inputdata/r_swds.csv')['r_op_swds_0']
r_pr_mss = pd.read_csv(path + 'inputdata/r_mss.csv')['r_pr_mss_0']
r_cp_mss = pd.read_csv(path + 'inputdata/r_mss.csv')['r_cp_mss_0']
r_op_mss = pd.read_csv(path + 'inputdata/r_mss.csv')['r_op_mss_0']
...
class SewerSystem:
    ...
    def sol(self, pr_no_meas_area, cp_no_meas_area, op_no_meas_area, r_pr_swds, r_cp_swds,
            r_op_swds, r_pr_mss, r_cp_mss, r_op_mss, meas_swds, meas_mss, ow_no_meas_area):
        # parameters
...
while t <= iters - 1:
    sol = m.sol(pr_no_meas_area, cp_no_meas_area, op_no_meas_area, r_pr_swds[t], r_cp_swds[t], r_op_swds[t], r_pr_mss[t]
                , r_cp_mss[t], r_op_mss[t], meas_swds[t], meas_mss[t], ow_no_meas_area)
...
def validate(a, b, c, d, e, f, A1, A2):
    ...
    while t <= iters - 1:
        sol = m.sol(pr_no_meas_area, cp_no_meas_area, op_no_meas_area, r_pr_swds[t], r_cp_swds[t], r_op_swds[t],
                    r_pr_mss[t], r_cp_mss[t], r_op_mss[t], meas_swds[t], meas_mss[t], ow_no_meas_area)
...
R_swds_all = pd.read_csv(path + 'inputdata/r_swds.csv')
R_mss_all = pd.read_csv(path + 'inputdata/r_mss.csv')
